...
<head>
	...
	<noscript><div><img src="https://mc.yandex.ru/watch/103178591" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
	<!-- /Yandex.Metrika counter -->
</head>

<body>
	<header class="d-block header-top py-0 header-nav-index">
		<nav class="header-nav-top navbar navbar-expand-lg navbar-light d-none d-lg-block bg-transparent">
			<div class="container">
				<div class="collapse navbar-collapse">
					<ul class="navbar-nav ms-auto align-items-center">
						...
						<li class="nav-item me-3">
							<div class="d-flex align-items-center gap-3 lh-1 nav-link-text time">
								<img src="<?php echo get_template_directory_uri(); ?>/img/ico/clock-ico.svg" />
								Без выходных с 9:00 до 21:00
							</div>
						</li>
						<li class="nav-item me-3">
							<button class="nav-link d-flex align-items-center gap-3 lh-1 marker" data-bs-toggle="modal"
		...
		<nav class="header-nav-bottom navbar navbar-expand-lg navbar-light py-1 py-lg-0 bg-transparent">
			<div class="container">
						...
						<div class="col">
							...
							<div class="row align-items-center mb-2">
								<div class="col-md-6 col-lg-3 mb-2 mb-md-4">
									<div class="row align-items-center ico-wrapper">
										<div class="col-2 col-lg-3">
											<img src="<?php echo get_template_directory_uri(); ?>/img/ico/home-icon-1.svg"
								...
								<div class="col-md-6 col-lg-3 mb-2 mb-md-4">
									<div class="row align-items-center ico-wrapper">
										<div class="col-2 col-lg-3">
											<img src="<?php echo get_template_directory_uri(); ?>/img/ico/home-icon-2.svg"
												class="img-fluid home-ico" />
										</div>
										<div class="col-10 col-lg-9">
											<p class="advantage-text text-start mb-0">
								...
								<div class="col-md-6 col-lg-3 mb-2 mb-md-4">
									<div class="row align-items-center ico-wrapper">
										<div class="col-2 col-lg-3">
											<img src="<?php echo get_template_directory_uri(); ?>/img/ico/home-icon-3.svg"
												class="img-fluid home-ico" />
										</div>
										<div class="col-10 col-lg-9">
											<p class="advantage-text text-start mb-0">
								...
								<div class="col-md-6 col-lg-3 mb-2 mb-md-4">
									<div class="row align-items-center ico-wrapper">
										<div class="col-2 col-lg-3">
											<img src="<?php echo get_template_directory_uri(); ?>/img/ico/home-icon-4.svg"
												class="img-fluid home-ico" />
										</div>
										<div class="col-10 col-lg-9">
											<p class="advantage-text text-start mb-0">
		...
		<div class="container">
			<div class="row">
				...
				<div id="portfolio-container">
					<div class="row">
						<?php echo get_portfolio_items_for_frontend(6, 1); ?>
					</div>
				</div>

				<?php if (has_more_portfolio_items(1, 6)): ?>
					<div class="text-center mt-5" id="load-more-container">
						<button type="button" class="btn" id="load-more-portfolio">
	...
	<script>
		document.addEventListener('DOMContentLoaded', function () {
					...
					fetch('<?php echo admin_url('admin-ajax.php'); ?>', {
						...
						.then(data => {
							if (data.success && data.data.html) {
								...
								portfolioContainer.insertAdjacentHTML('beforeend', data.data.html);
								...
								console.error('Ошибка загрузки портфолио:', data);
								currentPage--; // Возвращаем страницу назад при ошибке
							}
						})
						.catch(error => {
			...
			// Обновленная функция openGallery для работы с новым портфолио
			window.openGalleryFromPortfolio = function (carouselId) {
				...
				carouselItems.forEach((item, index) => {
					...
					if (mainImg && mainImg.src && !mainImg.src.includes('zoom') && !mainImg.classList.contains('zoom-icon')) {
						images.push({
							src: mainImg.src,
			...
			// Перенаправляем вызовы openGallery на новую функцию
			window.openGallery = window.openGalleryFromPortfolio;
		});
	</script>
	...
	<section class="section section-half price-section bg-grey">
		<div class="d-flex flex-wrap half-bg">
			...
			<div class="right-part left-part d-none d-md-block">
				<img src="<?php echo get_template_directory_uri(); ?>/img/order-left-gradient-section-bg.jpg" alt="Изображение"
					class="img-cover" />
			</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-md-6">
					...
					<img src="<?php echo get_template_directory_uri(); ?>/img/ico/points.svg" alt="Точки"
						class="img-fluid img-points" />
		...
		<div class="container">
			<div class="row">
				...
				<div class="col">
					...
					<div class="price-item">
						<span class="price-name">Адгезия (улучшение сцепления с поверхностью)</span>
						<span class="price-value price-text">от 350 руб/кв.м</span>
					</div>
					<div class="price-item">
						<span class="price-name">Закупка и доставка высококачественного материала</span>
	...
	<section class="section section-half section-who-makes">
		<div class="d-flex flex-wrap half-bg">
			...
			<div class="right-part d-none d-md-block">
				<img src="<?php echo get_template_directory_uri(); ?>/img/order-left-gradient-section-bg-two.jpg"
					alt="Изображение" class="img-cover" />
			</div>
		</div>
	...
	<section class="section section-how bg-grey">
		<div class="container">
			<div class="row">
				<div class="section-title text-center">
					<h3>Как заказать</h3>
					<img src="<?php echo get_template_directory_uri(); ?>/img/ico/points.svg" alt="Описание изображения"
						class="img-fluid" />
				</div>
					...
					<div class="accordion-item mb-3">
						<h3 class="accordion-header" id="heading-1">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
								...
								За какое время отштукатурите коттедж 300 кв.м?
							</button>
						</h3>
						<div id="collapse-1" class="accordion-collapse collapse" aria-labelledby="heading-1"
							...
							<div class="accordion-body">
								<p class="mb-0">
									6-7 дней, в зависимости от сложности
								</p>
							</div>
						</div>
					</div>
					...
					<div class="accordion-item mb-3">
						<h3 class="accordion-header" id="heading-2">
							<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2"
								...
								Какова стоимость кв.м. ваших услуг при слое штукатурки больше 3см.?
							</button>
						</h3>
						<div id="collapse-2" class="accordion-collapse collapse show" aria-labelledby="heading-2"
							...
							<div class="accordion-body">
								<p class="mb-0">
									Свыше 3см. - 300 рублей за кв м. той площади, где превышает 3 см!
								</p>
							</div>
						</div>
					</div>
					...
					<div class="accordion-item mb-3">
						<h3 class="accordion-header" id="heading-3">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
								...
								Какой фирмы материал используете при работе!
							</button>
						</h3>
						<div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="heading-3"
							...
							<div class="accordion-body">
								<p class="mb-0">
									Стараемся работать с официальным представителем Кнауф!
								</p>
							</div>
						</div>
					</div>
	...
	<section class="section section-half section-faq" id="contacts">
		<div class="d-flex flex-wrap half-bg">
			<!-- Левая часть с картинкой (скрывается на мобилках) -->
			<div class="right-part left-part d-none d-md-block">
				<img src="<?php echo get_template_directory_uri(); ?>/img/order-left-gradient-section-bg-free.jpg"
					alt="Изображение" class="img-cover" />
			</div>
			<!-- Правая часть с фоном -->
			<div class="left-part flex-grow-1"></div>
	...
	<section class="footer bg-dark">
		...
		<div class="container py-5 d-none d-xl-block">
			<div class="row align-items-center">
				<div class="col-xl-2">
					<a href="#">
						<img id="navbar-brand-img" src="<?php echo get_template_directory_uri(); ?>/img/logo-light.svg"
							class="img-fluid" />
					</a>
				</div>
				<div class="col-xl-8">
			...
			<div class="row">
				<div class="col py-4 d-flex justify-content-center align-items-center">
					<ul class="nav footer-nav align-items-center">
						...
						<li class="nav-item me-3">
							<a class="nav-link d-flex align-items-center gap-3 lh-1" href="mailto:Kuzmindima1986@mail.ru">
								<img src="<?php echo get_template_directory_uri(); ?>/img/ico/email-ico.svg" />
								Kuzmindima1986@mail.ru
							</a>
						</li>
						...
						<li class="nav-item me-3">
							<a class="nav-link d-flex align-items-center gap-3 lh-1 tel" href="tel:+79209542860">
								<img src="<?php echo get_template_directory_uri(); ?>/img/ico/telephone-2.svg" />
								8 (920) 954-28-60
							</a>
						</li>
			...
			<div class="row">
				<div class="col py-5">
					...
					<ul class="ps-0 pt-5 pt-md-3 pb-2 navbar-nav">
						...
						<li class="nav-item">
							<a href="mailto:Kuzmindima1986@mail.ru" class="nav-link ps-0 py-2 footer-mail">
					...
					<div class="row footer-menu">
						<div class="col-6">
							<ul class="nav flex-column">
								<li class="nav-item">
									<a class="nav-link ps-0 active" href="#carouselMain">Главная</a>
								</li>

								<li class="nav-item">
									<a class="nav-link ps-0 active" href="#jobs">Наши работы</a>
								</li>

								<li class="nav-item">
									<a class="nav-link ps-0 active" href="#plasters">Виды штукатурки</a>
								</li>
							</ul>
						</div>
						<div class="col-6">
							<ul class="nav flex-column">
								...
								<li class="nav-item">
									<a class="nav-link ps-0" href="#contacts">Контакты</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div id="galleryModal" class="modal-gallery" style="
				display: none;
				position: fixed;
				top: 0;
				left: 0;
				...
				z-index: 9999;
			">
		<div id="modalCarousel" class="carousel slide h-100" data-bs-ride="false" data-bs-interval="false">
		...
		<button type="button" onclick="closeGallery()" class="btn-close btn-close-white"
			style="position: fixed; top: 25px; right: 25px; z-index: 10000" aria-label="Close"></button>
	</div>
	...
	<script
		type="text/javascript"> (function (m, e, t, r, i, k, a) { m[i] = m[i] || function () { (m[i].a = m[i].a || []).push(arguments) }; m[i].l = 1 * new Date(); for (var j = 0; j < document.scripts.length; j++) { if (document.scripts[j].src === r) { return; } } k = e.createElement(t), a = e.getElementsByTagName(t)[0], k.async = 1, k.src = r, a.parentNode.insertBefore(k, a) })(window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(103178591, "init", { clickmap: true, trackLinks: true, accurateTrackBounce: true, webvisor: true }); </script>
</body>
